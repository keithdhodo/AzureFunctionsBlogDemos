...
namespace Chapter03.Tests
{
    ...
    public class JosephusTests
    {
        ...
        {
            var result = new Josephus(numberOfParticipants: (int)Math.Pow(10, 4), orderToRemoveParticipants: 2).ExecuteJosephusSimulation();
        ...
        {
            var result = new Josephus(numberOfParticipants: (int)Math.Pow(10, 5), orderToRemoveParticipants: 2).ExecuteJosephusSimulation();
            Assert.AreEqual(99999, result.Item);
        }

        [TestMethod]
        public void Josephus_TestOneMillionParticipantsAndEliminateByFive()
        {
            var result = new Josephus(numberOfParticipants: (int)Math.Pow(10, 6), orderToRemoveParticipants: 2).ExecuteJosephusSimulation();
