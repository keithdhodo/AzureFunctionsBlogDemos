...
{
    public static class WeightedQuickUnionTopicTrigger
    {
        [FunctionName("WeightedQuickUnionTopicTrigger")]
        public static void Run(
            [ServiceBusTrigger(Constants.Chapter01.AzureServiceBusTopicNameChapter01, 
                Constants.Chapter01.Chapter01WeightedQuickUnion, 
                AccessRights.Manage,
            ...
            IBinder binder)
        {
            ...
            performance.AlgorithmName = Constants.Chapter01.Chapter01WeightedQuickUnion;
            performance.PartitionKey = Constants.Chapter01.Chapter01WeightedQuickUnion;
